"""
run_test_scenarios.py â€” Skill 289: herbal-essential-oil-extraction
...
SKILLS = ROOT / "skills"
GATES = ["U1","U2","U3","U4","U5","U6"] + [g["id"] for g in [{"id": "G1", "check": "Method & parameters set", "fix": "Set method/parameters"}, {"id": "G2", "check": "GC-MS profile & yield analyzed", "fix": "Analyze profile/yield"}, {"id": "G3", "check": "Aroma preservation addressed", "fix": "Address aroma"}, {"id": "G4", "check": "ISO/pharmacopoeia standardization", "fix": "Standardize"}]]
