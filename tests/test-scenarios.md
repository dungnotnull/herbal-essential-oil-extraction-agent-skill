# test-scenarios.md — Skill 289: herbal-essential-oil-extraction
...
- **Input:** a typical Essential Oil Extraction & Aromatic Chemistry case with complete inputs.
...
- **Verdict target:** Optimal Extraction.
...
### Verdict coverage
Optimal Extraction, Conditional (thermal), Yield/Aroma Loss, Inconclusive.
